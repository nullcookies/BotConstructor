...
urlpatterns = [
    ...
    path('createBot/secondStep/text/', CreateTextField.as_view(),
    ...
    path('createBot/secondStep/replyMarkup/deleteReplyButton/'
         '<int:markup_id>/<int:button_id>/', DeleteReplyButtonField.as_view(),
         name='create_bot_second_step_reply_button_delete_url'),
    path('createBot/secondStep/replyMarkup/deleteInlineButton/'
         '<int:markup_id>/<int:button_id>/', DeleteInlineButtonField.as_view(),
    ...
    path('createBot/secondStep/inlineMarkup/deleteInlineMarkup/'
         '<int:markup_id>', DeleteInlineMarkupField.as_view(),
    ...
    path('createBot/thirdStep/downloadConfig/', Download.config,
         name='download_config_url'),
    path('createBot/thirdStep/downloadScript/', Download.script,
         name='download_script_url'),
    path('updateBot/<int:bot_id>/', UpdateBot.as_view(),
         name='update_bot_url'),
