...
bot = telebot.TeleBot(token='cbX')


reply_markup_dictionary = {'ячсяЯ': {'resize_keyboard': True, 'one_time_keyboard': True, 'selective': False, 'row_width': 2, 'response_text': 'сыв', 'buttons': [{'response': 'чсмч', 'request_contact': True, 'request_location': True}]}}
